...
This package is in development and not yet on CRAN. You can install the DEV version directly from GitHub:
...
Or it can visualize all detectable pipeline code in a given file by way of `pipe_vizr_file()`:
